...
export default {
  asset: {
    font: {
      icon: {
        name: "MaterialIcons",
        ttf: "assets/fonts/MaterialIcons-Regular.ttf",
        eot: "assets/fonts/MaterialIcons-Regular.eot",
  ...
  content: {
    icon: {
      ...
      brightness_seven: "brightness_7",
      border_color: "border_color",
      border_clear: "border_clear",
      brightness_six: "brightness_6",
      brightness_five: "brightness_5",
      brightness_four: "brightness_4",
      brightness_three: "brightness_3",
      brightness_two: "brightness_2",
      brightness_one: "brightness_1",
      ...
      clear_all: "clear_all",
      crop_free: "crop_free",
      crop_onesix_nine: "crop_onesix_nine",
      check_box: "check_box",
      copyright: "copyright",
      cloud_off: "cloud_off",
      call_made: "call_made",
      contacts: "contacts",
      colorize: "colorize",
      crop_seven_five: "crop_seven_five",
      crop_five_four: "crop_five_four",
      crop_three_two: "crop_three_two",
      crop_din: "crop_din",
      computer: "computer",
      call_end: "call_end",
      compare: "compare",
      ...
      exposure_minus_two: "exposure_minus_two",
      exposure_minus_one: "exposure_minus_one",
      event_available: "event_available",
      exposure_plus_two: "exposure_plus_two",
      exposure_plus_one: "exposure_plus_one",
      exposure_neg_two: "exposure_neg_two",
      exposure_neg_one: "exposure_neg_one",
      ...
      filter_nine_plus: "filter_nine_plus",
      ...
      forward_threezero: "forward_threezero",
      filter_hdr: "filter_hdr",
      flash_auto: "flash_auto",
      forward_onezero: "forward_onezero",
      first_page: "first_page",
      flash_off: "flash_off",
      functions: "functions",
      fiber_pin: "fiber_pin",
      fiber_new: "fiber_new",
      forward_five: "forward_five",
      fiber_dvr: "fiber_dvr",
      filter_seven: "filter_seven",
      filter_six: "filter_six",
      filter_five: "filter_five",
      filter_four: "filter_four",
      feedback: "feedback",
      ...
      loyalty: "loyalty",
      looks_six: "looks_six",
      looks_five: "looks_five",
      looks_four: "looks_four",
      live_tv: "live_tv",
      ...
      rotate_ninezero_degrees_ccw: "rotate_ninezero_degrees_ccw",
      ...
      reply_all: "reply_all",
      replay_threezero: "replay_threezero",
      replay_onezero: "replay_onezero",
      rv_hookup: "rv_hookup",
      replay_five: "replay_five",
      rss_feed: "rss_feed",
      reorder: "reorder",
      restore: "restore",
      receipt: "receipt",
      ...
      room: "room",
      redo: "redo",
      signal_cellular_connected_no_internet_four_bar: "signal_cellular_connected_no_internet_four_bar",
      ...
      signal_wifi_four_bar_lock: "signal_wifi_four_bar_lock",
      ...
      signal_cellular_four_bar: "signal_cellular_four_bar",
      ...
      signal_wifi_four_bar: "signal_wifi_four_bar",
      ...
      tonality: "tonality",
      theaters: "theaters",
      timer_onezero: "timer_onezero",
      timeline: "timeline",
      texture: "texture",
      textsms: "textsms",
      traffic: "traffic",
      timer_three: "timer_three",
      terrain: "terrain",
      tablet: "tablet",
      title: "title",
      timer: "timer",
